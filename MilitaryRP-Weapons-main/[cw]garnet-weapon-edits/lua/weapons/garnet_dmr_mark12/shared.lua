...
SWEP.Attachments = {[1] = {header = "Sight", offset = {800, -500}, atts = {"md_schmidt_shortdot", "md_acog"}},
	[2] = {header = "Barrel", offset = {300, -500}, atts = {"md_saker"}},
	[3] = {header = "Rail", offset = {250, 400}, atts = {"md_anpeq15"}, dependencies = {bg_ris = true, bg_longris = true}}}
