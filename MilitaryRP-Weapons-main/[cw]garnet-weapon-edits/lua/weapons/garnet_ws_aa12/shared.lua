...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["md_cod4_reflex"] = { type = "Model", model = "models/v_cod4_reflex.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-6, -0.12, 1.149), angle = Angle(0, -180, 0), size = Vector(1.25, 1.25, 1.25), adjustment = {min = -7.3, max = -3.6, inverse = true, axis = "x", inverseOffsetCalc = true}},
		["md_cod4_eotech_v2"] = { type = "Model", model = "models/v_cod4_eotech.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-6, -0.101, 1.1), angle = Angle(0, 180, 0), size = Vector(1.25, 1.25, 1.25), adjustment = {min = -6.7, max = -5, inverse = true, axis = "x", inverseOffsetCalc = true}},
		...
		["md_backup_reflex"] = { type = "Model", model = "models/c_docter.mdl", bone = "RW_Weapon", rel = "", pos = Vector(19.5, 1.399, 3.799), angle = Angle(0, 0, 45), size = Vector(1, 1, 1)},
		["md_cod4_aimpoint_v2"] = { type = "Model", model = "models/v_cod4_aimpoint.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-6, -0.101, 1.1), angle = Angle(0, -180, 0), size = Vector(1.25, 1.25, 1.25), adjustment = {min = -7, max = -5, inverse = true, axis = "x", inverseOffsetCalc = true}},
		...
		["md_cod4_acog_v2"] = { type = "Model", model = "models/v_cod4_acog.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-5.7, -0.151, 1), angle = Angle(0, 180, 0), size = Vector(1.399, 1.399, 1.399), adjustment = {min = -6.5, max = -4, inverse = true, axis = "x", inverseOffsetCalc = true}},
		
		["md_fas2_holo"] = { type = "Model", model = "models/v_holo_sight_kkrc.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-4, -0.101, -0.801), angle = Angle(0, 0, 0), size = Vector(1.1, 1.1, 1.1), adjustment = {min = -6, max = -2, inverse = true, axis = "x", inverseOffsetCalc = true}},
...
SWEP.Attachments = {
	[1] = {header = "Sight", offset = {600, -500}, atts = {"md_microt1", "md_cod4_reflex", "md_eotech", "md_cod4_eotech_v2", "md_fas2_eotech", "md_aimpoint", "md_cod4_aimpoint_v2", "md_fas2_aimpoint", "md_acog", "md_cod4_acog_v2", "md_fas2_holo"}},
	...
	[8] = {header = "Hybrid Sights", offset = {600, 0}, atts = {"md_backup_reflex"}},
...
local ammo = self:Ammo1()
	...
	if self.ActiveAttachments.md_microt1 or self.ActiveAttachments.md_cod4_reflex then
		if self.WMEnt then
			self.WMEnt:SetBodygroup(5,1) 
		end
	elseif self.ActiveAttachments.md_eotech or self.ActiveAttachments.md_fas2_eotech or self.ActiveAttachments.md_cod4_eotech_v2 then
		if self.WMEnt then
			self.WMEnt:SetBodygroup(5,2) 
		end
	elseif self.ActiveAttachments.md_aimpoint or self.ActiveAttachments.md_cod4_aimpoint_v2 or self.ActiveAttachments.md_fas2_aimpoint then
		if self.WMEnt then
			self.WMEnt:SetBodygroup(5,3) 
		end
	elseif self.ActiveAttachments.md_acog or self.ActiveAttachments.md_cod4_acog_v2 then
		if self.WMEnt then
