...
SWEP.Attachments = {[1] = {header = "Sight", offset = {600, -250},  atts = {"md_microt1kh", "md_fas2_eotech", "md_fas2_aimpoint", "md_schmidt_shortdot"}}}
...
--------------- NEW ---------------
SWEP.EffectiveRange = 45 * 39.37

SWEP.DamageFallOff = .6
