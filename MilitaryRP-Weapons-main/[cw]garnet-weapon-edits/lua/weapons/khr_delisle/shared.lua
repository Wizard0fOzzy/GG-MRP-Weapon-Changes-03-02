...
SWEP.ShortDotPos = Vector(2.026, -9, 0.18)	SWEP.ShortDotAng = Vector(0.7, -0.05, 0)	SWEP.AttachmentModelsVM = {	["md_schmidt_shortdot"] = { type = "Model", model = "models/cw2/attachments/schmidt.mdl", bone = "SMDImport01", rel = "", pos = Vector(0.252, -6.266, -1.99), angle = Angle(0, 90, 0), size = Vector(0.699, 0.699, 0.699), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }	}	SWEP.Attachments = {[1] = {header = "Sight", offset = {600, -400},  atts = {"md_schmidt_shortdot"}}	}
