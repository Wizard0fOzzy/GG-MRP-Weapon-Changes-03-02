...
SWEP.AttachmentModelsVM = {
		["md_saker"] = {model = "models/cw2/attachments/556suppressor.mdl", bone = "lo_body002", pos = Vector(0, 9.373, -0.85), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 0.75)}
	}
...
SWEP.Attachments = {
	[2] = {header = "Barrel", offset = {-550, -100},  atts = {"md_saker"}}
}
...
SWEP.FireSoundSuppressed = "CW_L96_FIRE_SUPPRESSED"
SWEP.Recoil = 9
